...
NewSessionDialog::NewSessionDialog(SourceModel *sourceModel, bool hasApiKey,
  ...
  QShortcut *focusFilterShortcut =
      new QShortcut(QKeySequence(Qt::CTRL + Qt::Key_F), this);
  connect(focusFilterShortcut, &QShortcut::activated, m_filterEdit, [this]() {
  ...
  QPushButton *draftButton =
      new QPushButton(tr("Save as Draft (Ctrl+S)"), this);
  ...
  QShortcut *createEnterShortcut =
      new QShortcut(QKeySequence(Qt::CTRL + Qt::Key_Enter), this);
  connect(createEnterShortcut, &QShortcut::activated, m_createButton,
          &QPushButton::click);
  ...
  m_createPRButton =
      new QPushButton(tr("Create PR Session (Ctrl+Shift+Return)"), this);
  m_createPRButton->setDefault(true);
  m_createPRButton->setShortcut(
      QKeySequence(Qt::CTRL + Qt::SHIFT + Qt::Key_Return));
  QShortcut *createPREnterShortcut =
      new QShortcut(QKeySequence(Qt::CTRL + Qt::SHIFT + Qt::Key_Enter), this);
  connect(createPREnterShortcut, &QShortcut::activated, m_createPRButton,
          &QPushButton::click);
